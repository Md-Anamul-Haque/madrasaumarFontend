  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-white">
        <div className="mx-auto w-full max-w-lg">
            ...
            <p className="mt-3 text-center">Email us at help@domain.com or message us here:</p>
           ...
           Get your free access key from: https://web3forms.com/  -->
                ...
                <div className="grid justify-center gap-6">
                    <div className="px-10 w-screen">
                        <div className="relative z-0 mx-auto w-[70%] sm:w-[55%] md:w-[50%] lg:w-[40%] xl:w-[35%]">
                            ...
                            <label className="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-blue-600 peer-focus:dark:text-blue-500">Your
                                name</label>
                        </div>
                        <div className="relative mx-auto z-0  w-[70%] sm:w-[55%] md:w-[50%] lg:w-[40%] xl:w-[35%]">
                    ...
                    <div className="relative z-0 col-span-2 mx-auto z-0  w-[70%] sm:w-[55%] md:w-[50%] lg:w-[40%] xl:w-[35%]">
