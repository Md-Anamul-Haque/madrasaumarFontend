...
const AmaderOrjons = () => {
  ...
  return (
    ...
    <div className='flex flex-wrap w-full justify-center'>
      {datas && datas.orjon_in_world && <Orjon {...datas.orjon_in_world} />}
      {datas && datas.orjon_in_country && <Orjon {...datas.orjon_in_country} />}
      {datas && datas.orjon_in_madrasa && <Orjon {...datas.orjon_in_madrasa} />}
    </div>
